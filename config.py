...
TEST_SCENARIOS = [
    ...
    #     "description": "Test scenario where the LLM is asked to analyze the tasks.js file using the system prompt.",
    ...
    #     "description": "Test scenario where the LLM is asked to analyze the agent_process.js file using the system prompt.",
    ...
    # },
    {
        ...
        "prompt": "[system_prompt_ask] input/src/agent/commands/actions.js",
        "description": "Test scenario where the LLM is asked to analyze the actions.js file using the system prompt.",
        "file_to_analyze": "input/src/agent/commands/actions.js"
    }
]
